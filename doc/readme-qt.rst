Whistle-qt: Qt5 GUI for Whistle
===============================
...
A warning for people using the *static binary* version of Whistle on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Whistle is linked against libdb 5.0 (see also `this Debian issue`_).
